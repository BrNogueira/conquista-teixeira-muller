        ...
        <div class="content-wrapper grey">
            <div class="news-header">
                ...
                <div class="content-noticia ">
                    ...
                    <p class="regular-text">Água e sabão</p>                     
                    ...
                    <p class="regular-text">Acréscimo</p>                     
                    ...
                    <p class="regular-text">Roupas comuns</p>
                    ...
                    <p class="regular-text">Por unanimidade, a Turma deu provimento ao recurso para determinar a exclusão da condenação da Edisul ao ressarcimento das despesas pela lavagem do uniforme.</p>
                    <p class="regular-text">Fonte: TST
                    </p>
