        ...
        <div class="content-wrapper grey">
            <div class="news-header">
                ...
                <div class="content-noticia ">
                    ...
                    <p class="regular-text">A sentença, da juíza leiga Kátia de Camargo, foi homologada pelo juiz de Direito José Mauro Nagib Jorge, do Juizado Especial Cível e Criminal de Diamantino/MT. </p>
                    ...
                    <p class="regular-text">Além disso, demonstrou pagamentos realizados pela linha telefônica contratada desde 2012, afastando, assim, a suposta ilicitude na exigência da dívida e inscrição do nome.</p>
                    <p class="regular-text">“A requerida trouxe elementos que caracterizam a contratação do débito pela autora, tornando legítima a negativação em questão nos órgãos de proteção ao crédito. (...) Nesta senda, tendo requerida comprovado a existência da dívida, evidencia-se nos autos que a negativação do nome da parte autora foi devida.”</p>
                    <p class="regular-text">Segundo a decisão, se há alguma irregularidade que deve ser analisada, ela encontra-se no agir da parte requerente, “que na tentativa de se eximir de suas obrigações, tentou induzir em erro este Juízo alterando a verdade dos fatos, ficando caracterizada a litigância de má-fé.”</p>
                    ...
                    <p class="regular-text">Fonte: Migalhas</p>
